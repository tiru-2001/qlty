    ...
    <div  className="row contactSub justify-content-center">
     ...
     <div  className="row justify-content-evenly">
      <div className="col-md-3 touchSub">
        ...
        <h2   style={{color:" rgb(154, 78, 12)"}} className='text-center'><i class="fa-solid fa-phone"></i></h2>
      ...
      <div className="col-md-3 touchSub">
        ...
        <h2   style={{color:" rgb(154, 78, 12)"}}className='text-center'><i class="fa-solid fa-envelope"></i></h2>
